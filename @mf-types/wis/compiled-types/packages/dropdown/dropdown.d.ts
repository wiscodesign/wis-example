...
export interface DropdownTriggerProps extends Omit<DropdownProps, "open" | "defaultOpen" | "onOpen" | "children"> {
}
...
export interface DropdownButtonTriggerProps extends Omit<DropdownButtonProps, "open" | "defaultOpen" | "onOpen" | "children"> {
}
...
export interface DropdownItemProps extends Omit<HTMLAttributes<HTMLDivElement>, "onClick"> {
    /**
